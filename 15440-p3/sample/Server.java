...
public class Server extends UnicastRemoteObject implements ServerIntf{
    ...
    public static void main (String args[] ) throws Exception {
        ...
        LocateRegistry.getRegistry(selfIP, basePort).bind("//127.0.0.1/vmID" + String.valueOf(vmId), new Server());
        ...
        //non-master vm
            ...
            while (true) {
                try {
                    masterIntf = (ServerIntf) LocateRegistry.getRegistry(selfIP, basePort).lookup("//127.0.0.1/vmID1");
                    break;
                } catch (Exception e) {
                    continue;
                }
