...
public class Server extends UnicastRemoteObject implements IServer, Cloud.DatabaseOps {
    ...
    private static IServer masterIntf;
    ...
    public static void main (String args[] ) throws Exception {
        ...
        //non-master vm
            ...
            while (true) {
                try {
                    masterIntf = (IServer) LocateRegistry.getRegistry(selfIP, basePort).lookup("//localhost/no1");
                    break;
                } catch (Exception e) {
                    continue;
                }
    ...
    public static boolean scaleIn(int appNumber, int forNumber) throws Exception{
        ...
        if (System.currentTimeMillis() - lastScaleInTime >= SCALE_In_THRESHOLD) {
            ...
            for (int i = 0; i < appNumber; ++i){
                ...
                IServer curServer = (IServer) LocateRegistry.getRegistry(selfIP, basePort).lookup("//localhost/no"+String.valueOf(vmId));
